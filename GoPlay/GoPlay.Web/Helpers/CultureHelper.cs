...
public static class CultureHelper
{
    ...
    public static Dictionary<string, string> _languges = new Dictionary<string, string>()
	{
        //{"en-US", "English"},
        //{"id", "Indonesian"},
        //{"ms", "Malay"},
    ...
    public static string DisplayLanguage(string culture)
    {
        if (_languges.ContainsKey(culture))
        {
            return _languges[culture];
        }
        return _languges.First().Value.ToString();
    }

    public static string get_display_language(ApplicationUser currentUser, string locale)
    {
        try
        {
            if (currentUser != null)
            {
                return _languges[currentUser.locale];
            }
            if (!String.IsNullOrEmpty(locale))
            {
                return _languges[locale];
            }
        }
        catch (Exception)
        {
